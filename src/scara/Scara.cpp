...
//
//	xtrj1.addPose(TimeFactors::FAST,{160,0,0,0});
//	xtrj1.addPose(TimeFactors::FAST,{160,20,0,0});
//	xtrj1.addPose(TimeFactors::SLOW,{150,40,0,0});
...
void Scara::execute() {
	//Trajectory trj;
	//Q q = trj.ik2({0,160,0,0,0});

	//printf("Executed invoked. q1: %f, q2: %f, q3: %f, q4: %f\n\r",qTrj[i][1] ,qTrj[i][2],qTrj[i][3],qTrj[i][4]);
